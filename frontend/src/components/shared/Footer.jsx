      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://www.facebook.com/profile.php?id=61554950021351" className="hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://x.com/i/flow/login?redirect_after_login=%2FTHRMsocial" className="hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://www.instagram.com/thrm.digitalmarketing_agency/" className="hover:text-gray-400" aria-label="LinkedIn">
